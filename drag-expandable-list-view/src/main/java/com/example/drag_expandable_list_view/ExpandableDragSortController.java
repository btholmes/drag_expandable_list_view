...
public class ExpandableDragSortController extends ExpandableSimpleFloatViewMangager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private DragExpandableListView mDslv;
    private int mPositionX;

//    /**
////     * Calls {@link #ExpandableDragSortController(DragSortListView, int)} with a
...
//     */
    public ExpandableDragSortController(DragExpandableListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public ExpandableDragSortController(DragExpandableListView dslv, int dragHandleId, int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
    }

    public ExpandableDragSortController(DragExpandableListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId) {
     ...
     */
    public ExpandableDragSortController(DragExpandableListView dslv, int dragHandleId, int dragInitMode,
