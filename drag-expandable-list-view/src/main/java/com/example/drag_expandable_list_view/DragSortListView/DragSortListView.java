...
package com.example.drag_expandable_list_view.DragSortListView;
...
import com.example.drag_expandable_list_view.R;
...
//     */
    ...
    /**
     * That is where you should do your drawing, yes. draw(Canvas canvas) initiates drawing;
     * onDraw(Canvas canvas) is where drawing takes place;
     * dispatchDraw(Canvas canvas) is what tells the children of the ViewGroup to be drawn.
     * @param canvas
     */
